...
function buildCharts(sample) {
  ...
  var sample_values = result.sample_values;
    ...
    var barLayout = {
      ...
      font: { color: "blue", family: "Grilled Cheese" },
    ...
    var bubbleLayout = {
      ...
      height: 700,
      width: 1700,
      margin: { t: 25, r: 75, l: 25, b: 100 },
      font: { color: "cornflowerblue", family: "Times New" }
    };
    ...
    var gaugeData = [
      {
        ...
        title: { text: "Belly Button Washing Frequency", font: { size: 26}},
        type: "indicator",
        mode: "gauge+number",
    ...
    var gaugeLayout = { 
      ...
      paper_bgcolor: "lavender",
      font: { color: "dodgerblue", family: "Nyala" }      
    };
